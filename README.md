...
Our site is live https://github.com/Lokesh922003/Web-Application-Mimicking-Google-Sheets-.git
...
1. Clone the repository:  
   ```bash
   git clone https://github.com/Lokesh922003/Web-Application-Mimicking-Google-Sheets-.git
